...
var AnimatedColor = /* @__PURE__ */function (AnimatedWithChildren2) {
  ...
  function AnimatedColor2(valueIn, config) {
    ...
    if (isRgbaAnimatedValue(value)) {
      ...
      var _processColor,
        processedColor = (_processColor = processColor(value)) !== null && _processColor !== void 0 ? _processColor : defaultColor,
    ...
    */
    ...
    value: function (value) {
      ...
      if (this.__isNative) {
        ...
        shouldUpdateNodeConfig && NativeAnimatedAPI.updateAnimatedNodeConfig(nativeTag1, this.__getNativeConfig()), NativeAnimatedAPI.unsetWaitingForIdentifier(nativeTag1.toString());
      }
    }
  }, {
    /**
