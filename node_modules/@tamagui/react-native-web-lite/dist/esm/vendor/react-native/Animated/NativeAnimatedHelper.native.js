import NativeAnimatedNonTurboModule from "./NativeAnimatedModule.native.js";
import NativeAnimatedTurboModule from "./NativeAnimatedTurboModule.native.js";
import NativeEventEmitter from "../EventEmitter/NativeEventEmitter.native.js";
import Platform from "../Utilities/Platform.native.js";
import ReactNativeFeatureFlags from "../ReactNative/ReactNativeFeatureFlags.native.js";
import { invariant } from "@tamagui/react-native-web-internals";
import RCTDeviceEventEmitter from "../EventEmitter/RCTDeviceEventEmitter.native.js";
...
function validateStyles(styles) {
  for (var key in styles) if (!isSupportedStyleProp(key)) throw new Error(`Style property '${key}' is not supported by native animated module`);
}
function validateInterpolation(config) {
  for (var key in config) if (!isSupportedInterpolationParam(key)) throw new Error(`Interpolation property '${key}' is not supported by native animated module`);
}
...
//# sourceMappingURL=NativeAnimatedHelper.native.js.map
