...
var AnimatedDivision = /* @__PURE__ */function (AnimatedWithChildren2) {
    ...
    function AnimatedDivision2(a, b) {
      ...
      var _this;
      return _this = _call_super(this, AnimatedDivision2), _define_property(_this, "_a", void 0), _define_property(_this, "_b", void 0), _define_property(_this, "_warnedAboutDivideByZero", !1), (b === 0 || b instanceof AnimatedNode && b.__getValue() === 0) && console.error("Detected potential division by zero in AnimatedDivision"), _this._a = typeof a == "number" ? new AnimatedValue(a) : a, _this._b = typeof b == "number" ? new AnimatedValue(b) : b, _this;
    }
  ...
  AnimatedDivision_default = AnimatedDivision;
export { AnimatedDivision_default as default };
//# sourceMappingURL=AnimatedDivision.native.js.map
