...
var import_VirtualizedList = __toESM(require("../VirtualizedList")), React = __toESM(require("react")), import_jsx_runtime = require("react/jsx-runtime");
const defaultProps = {
  data: [],
  key: null,
  renderItem: null,
...
class VirtualizedSectionList extends React.PureComponent {
  ...
  render() {
    const {
      ...
      ...passThroughProps
    } = this.props, listHeaderOffset = this.props.ListHeaderComponent ? 1 : 0, stickyHeaderIndices = this.props.stickySectionHeadersEnabled ? [] : void 0;
    let itemCount = 0;
    for (const section of this.props.sections)
      stickyHeaderIndices?.push(itemCount + listHeaderOffset), itemCount += 2, itemCount += this.props.getItemCount(section.data);
  ...
  _renderItem = (itemCount) => ({ item, index }) => index === 0 || index === itemCount - 1 ? null : (this.props.renderItem || this._defaultRenderItem)({ item, index, section: item });
