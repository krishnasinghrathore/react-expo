...
var import_react_native_web_internals = require("@tamagui/react-native-web-internals"), import_RCTDeviceEventEmitter = __toESM(require("./RCTDeviceEventEmitter"));
...
var NativeEventEmitter = /* @__PURE__ */ function() {
  function NativeEventEmitter2(nativeModule) {
    _class_call_check(this, NativeEventEmitter2), _define_property(this, "_nativeModule", void 0), import_react_native_web_internals.Platform.OS === "ios" && ((0, import_react_native_web_internals.invariant)(nativeModule != null, "`new NativeEventEmitter()` requires a non-null argument."), this._nativeModule = nativeModule);
  }
  return _create_class(NativeEventEmitter2, [
    {
      key: "addListener",
      value: function(eventType, listener, context) {
        var _this = this, _this__nativeModule;
    ...
    },
    {
      ...
      */
      ...
      value: function(eventType, listener) {
        ...
        (_this__nativeModule = this._nativeModule) === null || _this__nativeModule === void 0 || _this__nativeModule.removeListeners(1), import_RCTDeviceEventEmitter.default.removeListener(eventType, listener);
      }
    },
    {
      key: "emit",
    ...
    },
    {
      ...
      value: function(eventType) {
        var _this__nativeModule;
        (0, import_react_native_web_internals.invariant)(eventType != null, "`NativeEventEmitter.removeAllListener()` requires a non-null argument."), (_this__nativeModule = this._nativeModule) === null || _this__nativeModule === void 0 || _this__nativeModule.removeListeners(this.listenerCount(eventType)), import_RCTDeviceEventEmitter.default.removeAllListeners(eventType);
      }
    },
    {
      key: "listenerCount",
