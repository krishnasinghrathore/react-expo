...
var import_react_native_web_internals = require("@tamagui/react-native-web-internals"),
  ...
  import_ViewabilityHelper = __toESM(require("../ViewabilityHelper/index.cjs")),
...
class VirtualizedList extends import_StateSafePureComponent.default {
  ...
  render() {
    ...
    return getItemCount(data) === 0 ? ListEmptyComponent ? /* @__PURE__ */(0, import_jsx_runtime.jsx)(ListEmptyComponent, {}) : null : /* @__PURE__ */(0, import_jsx_runtime.jsx)(import_ScrollView.default, {
      ...restProps,
