...
var CellRenderMask = /* @__PURE__ */ function() {
  ...
  function CellRenderMask2(numCells) {
    _class_call_check(this, CellRenderMask2), (0, import_react_native_web_internals.invariant)(numCells >= 0, "CellRenderMask must contain a non-negative number os cells"), this._numCells = numCells, numCells === 0 ? this._regions = [] : this._regions = [
      {
        first: 0,
        last: numCells - 1,
        isSpacer: !0
