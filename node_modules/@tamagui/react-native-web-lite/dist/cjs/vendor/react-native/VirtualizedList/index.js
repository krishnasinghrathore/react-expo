...
class VirtualizedList extends import_StateSafePureComponent.default {
  ...
  constructor(props) {
    super(props), this._nestedChildLists = new import_ChildListCollection.default(), this._viewabilityTuples = [], this._scrollMetrics = {
      contentLength: 0,
      dOffset: 0,
      dt: 10,
      offset: 0,
      ...
      velocity: 0,
      visibleLength: 0
    }, this._highestMeasuredFrameIndex = 0, this._headerLength = 0, this._footerLength = 0, this._averageCellLength = 0, this._hasWarned = {}, this._fillRateHelper = new import_FillRateHelper.default(this._getFrameMetrics), this._updateCellsToRenderBatcher = new import_Batchinator.default(
      this._updateCellsToRender,
      this.props.updateCellsBatchingPeriod ?? 50
    ), this.props.viewabilityConfig && this.props.onViewableItemsChanged && this._viewabilityTuples.push({
      viewabilityHelper: new import_ViewabilityHelper.default(this.props.viewabilityConfig),
  ...
  render() {
    ...
    return getItemCount(data) === 0 ? ListEmptyComponent ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ListEmptyComponent, {}) : null : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      import_ScrollView.default,
      {
        ...
        refreshControl: onRefresh && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_RefreshControl.default, { refreshing, onRefresh }),
