...
var import_View = __toESM(require("../../../View")), import_react_native_web_internals = require("@tamagui/react-native-web-internals"), import_VirtualizedListContext = require("./VirtualizedListContext"), React = __toESM(require("react")), import_jsx_runtime = require("react/jsx-runtime");
class CellRenderer extends React.Component {
  ...
  render() {
    const {
      ...
      onCellLayout,
      renderItem
    } = this.props, element = this._renderElement(renderItem, ListItemComponent, item, index), itemSeparator = React.isValidElement(ItemSeparatorComponent) ? (
      // $FlowFixMe[incompatible-type]
      ItemSeparatorComponent
    ) : (
      // $FlowFixMe[incompatible-type]
      ItemSeparatorComponent && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ItemSeparatorComponent, { ...this.state.separatorProps })
    ), cellStyle = inversionStyle ? horizontal ? [styles.rowReverse, inversionStyle] : [styles.columnReverse, inversionStyle] : horizontal ? [styles.row, inversionStyle] : inversionStyle, result = CellRendererComponent ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      CellRendererComponent,
      {
        cellKey,
        index,
