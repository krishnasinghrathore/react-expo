...
var DecayAnimation = /* @__PURE__ */ function(Animation2) {
  ...
  function DecayAnimation2(config) {
    ...
    _this._deceleration = (_config_deceleration = config.deceleration) !== null && _config_deceleration !== void 0 ? _config_deceleration : 0.998, _this._velocity = config.velocity, _this._useNativeDriver = (0, import_NativeAnimatedHelper.shouldUseNativeDriver)(config);
