...
class AnimatedDivision extends import_AnimatedWithChildren.default {
  ...
  constructor(a, b) {
    super(), (b === 0 || b instanceof import_AnimatedNode.default && b.__getValue() === 0) && console.error("Detected potential division by zero in AnimatedDivision"), this._a = typeof a == "number" ? new import_AnimatedValue.default(a) : a, this._b = typeof b == "number" ? new import_AnimatedValue.default(b) : b;
  }
