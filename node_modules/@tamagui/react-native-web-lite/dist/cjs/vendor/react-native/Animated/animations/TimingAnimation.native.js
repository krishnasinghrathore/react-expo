...
var import_Easing = __toESM(require("../Easing")), import_Animation = __toESM(require("./Animation")), import_NativeAnimatedHelper = require("../NativeAnimatedHelper");
...
var TimingAnimation = /* @__PURE__ */ function(Animation2) {
  ...
  function TimingAnimation2(config) {
    ...
    var _this;
    _this = _call_super(this, TimingAnimation2), _define_property(_this, "_startTime", void 0), _define_property(_this, "_fromValue", void 0), _define_property(_this, "_toValue", void 0), _define_property(_this, "_duration", void 0), _define_property(_this, "_delay", void 0), _define_property(_this, "_easing", void 0), _define_property(_this, "_onUpdate", void 0), _define_property(_this, "_animationFrame", void 0), _define_property(_this, "_timeout", void 0), _define_property(_this, "_useNativeDriver", void 0), _define_property(_this, "_platformConfig", void 0), _this._toValue = config.toValue;
    var _config_easing;
    _this._easing = (_config_easing = config.easing) !== null && _config_easing !== void 0 ? _config_easing : easeInOut();
    var _config_duration;
    _this._duration = (_config_duration = config.duration) !== null && _config_duration !== void 0 ? _config_duration : 500;
    var _config_delay;
    _this._delay = (_config_delay = config.delay) !== null && _config_delay !== void 0 ? _config_delay : 0;
    var _config_iterations;
    _this.__iterations = (_config_iterations = config.iterations) !== null && _config_iterations !== void 0 ? _config_iterations : 1, _this._useNativeDriver = (0, import_NativeAnimatedHelper.shouldUseNativeDriver)(config), _this._platformConfig = config.platformConfig;
    var _config_isInteraction;
    return _this.__isInteraction = (_config_isInteraction = config.isInteraction) !== null && _config_isInteraction !== void 0 ? _config_isInteraction : !_this._useNativeDriver, _this;
  }
