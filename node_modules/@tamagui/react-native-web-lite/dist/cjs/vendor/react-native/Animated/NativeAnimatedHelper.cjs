...
var import_NativeAnimatedModule = __toESM(require("./NativeAnimatedModule.cjs")),
  import_NativeAnimatedTurboModule = __toESM(require("./NativeAnimatedTurboModule.cjs")),
  import_NativeEventEmitter = __toESM(require("../EventEmitter/NativeEventEmitter.cjs")),
  import_Platform = __toESM(require("../Utilities/Platform.cjs")),
  import_ReactNativeFeatureFlags = __toESM(require("../ReactNative/ReactNativeFeatureFlags.cjs")),
  import_react_native_web_internals = require("@tamagui/react-native-web-internals"),
  import_RCTDeviceEventEmitter = __toESM(require("../EventEmitter/RCTDeviceEventEmitter.cjs"));
...
import_Platform.default.OS === "android" && NativeAnimatedModule?.queueAndExecuteBatchedOperations && import_ReactNativeFeatureFlags.default.animatedShouldUseSingleOp();
...
var NativeAnimatedHelper_default = {
  ...
  get nativeEventEmitter() {
    ...
    import_Platform.default.OS !== "ios" ? null : NativeAnimatedModule)), nativeEventEmitter;
  }
};