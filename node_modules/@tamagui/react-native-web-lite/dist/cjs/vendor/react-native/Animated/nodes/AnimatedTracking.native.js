...
var import_AnimatedValue = require("./AnimatedValue"), import_AnimatedNode = __toESM(require("./AnimatedNode")), import_NativeAnimatedHelper = require("../NativeAnimatedHelper");
...
var AnimatedTracking = /* @__PURE__ */ function(AnimatedNode2) {
  ...
  function AnimatedTracking2(value, parent, animationClass, animationConfig, callback) {
    ...
    var _this;
    return _this = _call_super(this, AnimatedTracking2), _define_property(_this, "_value", void 0), _define_property(_this, "_parent", void 0), _define_property(_this, "_callback", void 0), _define_property(_this, "_animationConfig", void 0), _define_property(_this, "_animationClass", void 0), _define_property(_this, "_useNativeDriver", void 0), _this._value = value, _this._parent = parent, _this._animationClass = animationClass, _this._animationConfig = animationConfig, _this._useNativeDriver = (0, import_NativeAnimatedHelper.shouldUseNativeDriver)(animationConfig), _this._callback = callback, _this.__attach(), _this;
  }
