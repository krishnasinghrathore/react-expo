...
var AnimatedWithChildren = /* @__PURE__ */ function(AnimatedNode2) {
  ...
  function AnimatedWithChildren2() {
    ...
    var _this;
    return _this = _call_super(this, AnimatedWithChildren2), _define_property(_this, "_children", void 0), _this._children = [], _this;
  }
  return _create_class(AnimatedWithChildren2, [
    {
      ...
      value: function(platformConfig) {
        if (!this.__isNative) {
          ...
          try {
            for (var _iterator = this._children[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = !0) {
