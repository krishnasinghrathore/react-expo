...
var import_NativeAnimatedHelper = __toESM(require("../NativeAnimatedHelper")), import_react_native_web_internals = require("@tamagui/react-native-web-internals");
  ...
  return _create_class(AnimatedNode2, [
    ...
    },
    {
      ...
      value: function() {
        ...
        var _this___nativeTag, nativeTag = (_this___nativeTag = this.__nativeTag) !== null && _this___nativeTag !== void 0 ? _this___nativeTag : import_NativeAnimatedHelper.default.generateNewNodeTag();
