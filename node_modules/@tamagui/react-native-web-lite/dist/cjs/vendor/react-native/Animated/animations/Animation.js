...
class Animation {
  ...
  __startNativeAnimation(animatedValue) {
    ...
    startNativeAnimationNextId += 1, import_NativeAnimatedHelper.default.API.setWaitingForIdentifier(
    ...
    try {
      ...
      import_NativeAnimatedHelper.default.API.unsetWaitingForIdentifier(
        startNativeAnimationWaitId
      );
    }
  }
