...
var import_jsx_runtime = require("react/jsx-runtime"), import_VirtualizedSectionList = __toESM(require("../VirtualizedSectionList")), React = __toESM(require("react"));
...
var SectionList = /* @__PURE__ */ function(_React_PureComponent) {
  ...
  function SectionList2() {
    ...
    return _this = _call_super(this, SectionList2, arguments), _define_property(_this, "_captureRef", function(ref) {
      ...
      var { item, index, section } = param, renderItem = _this.props.renderItem || _this._defaultRenderItem;
      return renderItem({
        item,
        index,
        section
  ...
  return _create_class(SectionList2, [
    ...
    },
    {
      key: "render",
      value: function() {
        var { sections, ...passThroughProps } = this.props;
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_VirtualizedSectionList.default, {
          ...passThroughProps,
          sections,
