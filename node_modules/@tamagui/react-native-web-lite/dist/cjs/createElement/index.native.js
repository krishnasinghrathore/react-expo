...
var import_jsx_runtime = require("react/jsx-runtime"), import_react_native_web_internals = require("@tamagui/react-native-web-internals"), import_web = require("@tamagui/web"), import_react = __toESM(require("react")), useCreateElement = function(component, props, options) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
    children: [
      element,
      styles ? (0, import_web.getStyleTags)(styles) : null
    ]
  });
  ...
  var Component = accessibilityComponent || component, domProps = (0, import_react_native_web_internals.createDOMProps)(Component, props, options), styles = import_react_native_web_internals.stylesFromProps.get(domProps), element = /* @__PURE__ */ import_react.default.createElement(Component, domProps), elementWithLocaleProvider = domProps.dir ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react_native_web_internals.LocaleProvider, {
