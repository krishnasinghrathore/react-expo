...
const PROVIDER_NAME = "ToastProvider", [Collection, useCollection] = createCollection("Toast"), { Provider: ToastProviderProvider, useStyledContext: useToastProviderContext } = createStyledContext(
  ...
  return /* @__PURE__ */ jsx(Collection.Provider, { scope, children: /* @__PURE__ */ jsx(
...
function ReprogapateToastProvider(props) {
  ...
  return /* @__PURE__ */ jsx(Collection.Provider, { scope: context.toastScope, children: /* @__PURE__ */ jsx(ToastProviderProvider, { ...context, children: /* @__PURE__ */ jsx(ToastImperativeProvider, { options: context.options, children }) }) });
}
