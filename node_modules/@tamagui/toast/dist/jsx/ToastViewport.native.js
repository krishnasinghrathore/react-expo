...
var VIEWPORT_NAME = "ToastViewport", VIEWPORT_DEFAULT_HOTKEY = [
  ...
  var { scope, hotkey = VIEWPORT_DEFAULT_HOTKEY, label = "Notifications ({hotkey})", name = "default", multipleToasts, zIndex, portalToRoot, ...viewportProps } = props, context = useToastProviderContext(scope), getItems = useCollection(scope || TOAST_CONTEXT), headFocusProxyRef = React.useRef(null), tailFocusProxyRef = React.useRef(null), wrapperRef = React.useRef(null), ref = React.useRef(null), onViewportChange = React.useCallback(function(el) {
