...
var ToastAnnounceExcludeFrame = styled(Stack, {
  ...
  var { scope, children, ...announceProps } = props, context = useToastProviderContext(scope), [renderAnnounceText, setRenderAnnounceText] = React.useState(!1), [isAnnounced, setIsAnnounced] = React.useState(!1);
