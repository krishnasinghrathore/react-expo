...
function ToastPortal(props) {
  ...
  return (import_react_native.Platform.OS === "android" || import_react_native.Platform.OS === "ios") && (content = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ToastProvider.ReprogapateToastProvider, { context, children })), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_portal.Portal, { zIndex: zIndex || Number.MAX_SAFE_INTEGER, children: content });
}
