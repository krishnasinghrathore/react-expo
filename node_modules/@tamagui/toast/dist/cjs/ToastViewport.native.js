...
var import_jsx_runtime = require("react/jsx-runtime"), import_animate_presence = require("@tamagui/animate-presence"), import_compose_refs = require("@tamagui/compose-refs"), import_constants = require("@tamagui/constants"), import_core = require("@tamagui/core"), import_portal = require("@tamagui/portal"), import_stacks = require("@tamagui/stacks"), import_visually_hidden = require("@tamagui/visually-hidden"), React = __toESM(require("react")), import_constants2 = require("./constants"), import_ToastPortal = require("./ToastPortal"), import_ToastProvider = require("./ToastProvider"), VIEWPORT_NAME = "ToastViewport", VIEWPORT_DEFAULT_HOTKEY = [
  ...
  var { scope, hotkey = VIEWPORT_DEFAULT_HOTKEY, label = "Notifications ({hotkey})", name = "default", multipleToasts, zIndex, portalToRoot, ...viewportProps } = props, context = (0, import_ToastProvider.useToastProviderContext)(scope), getItems = (0, import_ToastProvider.useCollection)(scope || import_constants2.TOAST_CONTEXT), headFocusProxyRef = React.useRef(null), tailFocusProxyRef = React.useRef(null), wrapperRef = React.useRef(null), ref = React.useRef(null), onViewportChange = React.useCallback(function(el) {
  ...
  var getSortedTabbableCandidates = React.useCallback(function(param) {
    var { tabbingDirection } = param, toastItems = getItems(), tabbableCandidates = toastItems.map(function(toastItem) {
...
var FOCUS_PROXY_NAME = "ToastFocusProxy", FocusProxy = /* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
  var { onFocusFromOutsideViewport, viewportName, context, ...proxyProps } = props, viewport = context.viewports[viewportName];
