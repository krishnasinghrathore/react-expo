...
var import_jsx_runtime = require("react/jsx-runtime"), import_react = __toESM(require("react")), import_objectIdentityKey = require("./objectIdentityKey"), createReactContext = import_react.default[Math.random(), "createContext"];
function createStyledContext(defaultValues) {
  ...
  var getNamespacedScope = function(scope) {
    ...
    var { children, scope: scopeIn, ...values } = param, scope = getNamespacedScope(scopeIn), next = import_react.default.useMemo(function() {
      return {
    ...
    return scope && (Provider2 = getOrCreateScopedContext(scope).Provider), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LastScopeInNamespace.Provider, {
      value: scope,
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Provider2, {
        value: next,
        children
      })
    });
