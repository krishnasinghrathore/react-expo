...
var import_constants = require("@tamagui/constants"), import_config = require("../config"), import_createVariable = require("../createVariable"), import_doesRootSchemeMatchSystem = require("./doesRootSchemeMatchSystem"), import_getDynamicVal = require("../helpers/getDynamicVal");
  ...
  const proxied = Object.fromEntries(
    Object.entries(_state.theme).flatMap(([key, value]) => {
      const proxied2 = {
        ...
        get(platform) {
          if (!curState) return;
          const outVal = (0, import_createVariable.getVariable)(value), { name, scheme, inverses } = curState;
          return outVal;
        }
      };
      return [
