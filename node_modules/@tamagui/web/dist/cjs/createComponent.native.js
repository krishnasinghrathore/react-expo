  ...
  var component = /* @__PURE__ */ import_react.default.forwardRef(function(propsIn, forwardedRef) {
    ...
    if (splitStyles && (hasAnimationProp || groupName) && (animationDriver != null && animationDriver.avoidReRenders)) {
      ...
      stateRef.current.updateStyleListener = function() {
        var updatedState = NextState.get(stateRef) || state, mediaState2 = NextMedia.get(stateRef), { group, hasDynGroupChildren, unmounted, animation, ...childrenGroupState } = updatedState;
...
If you meant to do this, you can disable this warning - either change untilMeasured and group at the same time, or do group={conditional ? 'name' : undefined}`), process.env.NODE_ENV === "development" && time && time`destructure`, splitStyles && groupContext && // avoids onLayout if we don't need it
