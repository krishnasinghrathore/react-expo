...
const useComponentState = (props, animationDriver, staticConfig, config) => {
  ...
  const hasAnimationProp = !!("animation" in props || props.style && hasAnimatedStyleValue(props.style)), supportsCSS = animationDriver?.supportsCSS, curStateRef = stateRef.current;
