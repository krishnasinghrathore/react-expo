...
var time,
  NextState = /* @__PURE__ */new WeakMap(),
  ...
  var component = /* @__PURE__ */React.forwardRef(function (propsIn, forwardedRef) {
    ...
    if (splitStyles && (hasAnimationProp || groupName) && animationDriver?.avoidReRenders) {
      ...
      stateRef.current.updateStyleListener = function () {
        var updatedState = NextState.get(stateRef) || state,
        ...
        var prev = NextState.get(stateRef) || state,
        ...
        if (!(next === prev || isEqualShallow(prev, next))) {
          ...
          if (canAvoidReRender) {
            var _stateRef_current_updateStyleListener,
              _stateRef_current,
              updatedState = {
                ...prev,
                ...next
