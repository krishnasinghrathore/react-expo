...
function createStyledContext(defaultValues, namespace = "") {
  ...
  const getNamespacedScope = (scope) => namespace ? `${namespace}--${scope}` : scope, Provider = ({
    ...
    return scope && (Provider2 = getOrCreateScopedContext(scope).Provider), /* @__PURE__ */ jsx(LastScopeInNamespace.Provider, { value: scope, children: /* @__PURE__ */ jsx(Provider2, { value: next, children }) });
