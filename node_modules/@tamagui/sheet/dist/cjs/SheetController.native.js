...
var import_jsx_runtime = require("react/jsx-runtime"), import_react = __toESM(require("react")), import_core = require("@tamagui/core"), import_useSheetController = require("./useSheetController"), SheetController = function(param) {
  var { children, onOpenChange: onOpenChangeProp, open, hidden, disableDrag } = param, onOpenChange = (0, import_core.useEvent)(onOpenChangeProp), id = (0, import_react.useId)(), memoValue = import_react.default.useMemo(function() {
    return {
      id,
      open,
      hidden,
