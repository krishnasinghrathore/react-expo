...
var import_theme_builder = require("@tamagui/theme-builder"), import_componentThemeDefinitions = require("./componentThemeDefinitions"), import_theme_builder2 = require("@tamagui/theme-builder"), import_palettes = require("./palettes"), import_shadows = require("./shadows"), import_templates = require("./templates"), import_tokens = require("./tokens"), colorThemeDefinition = function(colorName) {
  return [
    {
      parent: "light",
      palette: colorName,
