...
function flattenStyle(style) {
  if (!(style === null || typeof style != "object")) {
    ...
    for (var result = {}, i = 0, styleLength = style.length; i < styleLength; ++i) {
      ...
      if (computedStyle) for (var key in computedStyle) hasOwnProperty.call(computedStyle, key) && (result[key] = computedStyle[key]);
    }
    return result;
  }
}
var stylesFromProps = /* @__PURE__ */new WeakMap(),
  createDOMProps = function (elementType, props, options) {
    ...
    var tmgCN = dataSet ? dataSet.className : void 0,
    ...
    var stylesAtomic = getCSSStylesAtomic(flat);
