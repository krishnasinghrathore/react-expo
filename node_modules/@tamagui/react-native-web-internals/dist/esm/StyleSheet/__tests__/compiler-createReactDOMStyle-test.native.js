import createReactDOMStyle from "../compiler/createReactDOMStyle.native.js";
...
describe("compiler/createReactDOMStyle", function () {
  test("noop on DOM styles", function () {
    var firstStyle = createReactDOMStyle(reactNativeStyle),
    ...
    test("string", function () {
      var transform = "perspective(50px) scaleX(20) translateX(20px) rotate(20deg)",
        style = {
          transform
        },
...
//# sourceMappingURL=compiler-createReactDOMStyle-test.native.js.map
