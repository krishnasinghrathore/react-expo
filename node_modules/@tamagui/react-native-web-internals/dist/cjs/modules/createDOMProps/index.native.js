...
var import_web = require("@tamagui/web"), import_AccessibilityUtil = __toESM(require("../AccessibilityUtil/index")), emptyObject = {}, hasOwnProperty = Object.prototype.hasOwnProperty, isArray = Array.isArray, uppercasePattern = /[A-Z]/g;
...
function flattenStyle(style) {
  if (!(style === null || typeof style != "object")) {
    if (!isArray(style))
      return style;
    for (var result = {}, i = 0, styleLength = style.length; i < styleLength; ++i) {
      var computedStyle = flattenStyle(style[i]);
      if (computedStyle)
        for (var key in computedStyle)
          hasOwnProperty.call(computedStyle, key) && (result[key] = computedStyle[key]);
    }
    return result;
  }
}
var stylesFromProps = /* @__PURE__ */ new WeakMap(), createDOMProps = function(elementType, props, options) {
  ...
  var flat = flattenStyle(style), className = tmgCN || "";
  props.className && (className += ` ${props.className}`);
  var stylesAtomic = (0, import_web.getCSSStylesAtomic)(flat);
