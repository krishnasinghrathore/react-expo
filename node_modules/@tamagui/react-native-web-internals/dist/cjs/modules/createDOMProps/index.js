...
var import_web = require("@tamagui/web"), import_AccessibilityUtil = __toESM(require("../AccessibilityUtil/index"));
...
const stylesFromProps = /* @__PURE__ */ new WeakMap(), createDOMProps = (elementType, props, options) => {
  ...
  const stylesAtomic = (0, import_web.getCSSStylesAtomic)(flat);
