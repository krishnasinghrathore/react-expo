...
const needsRepropagation = isAndroid || isIos && !USE_NATIVE_PORTAL, PopoverContext = createStyledContext(
  ...
  React.forwardRef(
    function(props, forwardedRef) {
      ...
      return context.open && isFullyHidden && setIsFullyHidden(!1), !context.keepChildrenMounted && isFullyHidden ? null : /* @__PURE__ */ jsx(
        PopoverPortal,
        {
...
function PopoverPortal({
  ...
  return /* @__PURE__ */ jsx(Portal, { passThrough, stackZIndex: !0, zIndex, children: /* @__PURE__ */ jsx(Theme, { passThrough, contain: !0, forceClassName: !0, name: themeName, children: /* @__PURE__ */ jsx(StackZIndexContext, { zIndex: resolveViewZIndex(zIndex), children: content }) }) });
}
